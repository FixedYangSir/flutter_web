...
class ThemeUtils {
  ...
  /*static Color getStickyHeaderColor(BuildContext context) {
    return isDark(context) ? Colours.dark_bg_gray: Colours.bg_gray;
  }
  ...
  static void setSystemBarStyle({Color color=Colors.black}) {
    if (Device.isAndroid) {
      ...
      final SystemUiOverlayStyle systemUiOverlayStyle = SystemUiOverlayStyle(
        ...
        systemNavigationBarIconBrightness: color==Colors.white?Brightness.light:Brightness.dark,
        statusBarIconBrightness: color==Colors.white?Brightness.light:Brightness.dark,
        statusBarBrightness: color==Colors.white?Brightness.dark:Brightness.light,
      );
